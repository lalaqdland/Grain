...
请提供3个不同的改写版本，每个版本用"---VERSION---"分隔。只输出改写后的文本，不要添加任何解释或标注。"""
...
Please provide 3 different rewritten versions, separated by "---VERSION---". Output only the rewritten text without any explanations or annotations."""
...
def get_prompt(mode: str, language: str, text: str) -> str:
    """
    获取对应的Prompt
